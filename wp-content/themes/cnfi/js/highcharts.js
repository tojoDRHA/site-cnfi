...
(function (P, N) {
    "object" === typeof module && module.exports
        ? ((N["default"] = N), (module.exports = P.document ? N(P) : N))
    ...
    N(H, "parts/Utilities.js", [H["parts/Globals.js"]], function (c) {
        ...
        function C(b, a, d) {
            ...
            A(a)
                ? y(d)
                    ? b.setAttribute(a, d)
                    : b && b.getAttribute && ((f = b.getAttribute(a)) || "class" !== a || (f = b.getAttribute(a + "Name")))
                : x(a, function (a, d) {
                      b.setAttribute(d, a);
                  });
            return f;
        ...
        function x(b, a, d) {
            for (var f in b) Object.hasOwnProperty.call(b, f) && a.call(d || b[f], b[f], f, b);
        }
        c.timers = [];
        var m = c.charts,
            p = c.doc,
        ...
        c.Fx.prototype = {
            ...
            run: function (b, a, d) {
                ...
                b !== a || this.elem["forceAnimate:" + this.prop]
                    ? ((this.startTime = +new Date()), (this.start = b), (this.end = a), (this.unit = d), (this.now = this.start), (this.pos = 0), (h.elem = this.elem), (h.prop = this.prop), h() && 1 === c.timers.push(h) && r(E))
                    : (delete e.curAnim[this.prop], e.complete && 0 === Object.keys(e.curAnim).length && e.complete.call(this.elem));
            },
            step: function (b) {
                var a = +new Date(),
                    d = this.options,
        ...
        c.normalizeTickInterval = function (b, a, d, f, e) {
            ...
            var r = b / d;
            a ||
                ((a = e ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
                !1 === f &&
                    (1 === d
            ...
            return (h = c.correctFloat(h * d, -Math.round(Math.log(0.001) / Math.LN10)));
        };
        ...
        c.getStyle = function (b, a, d) {
            if ("width" === a)
                return (
                    (a = Math.min(b.offsetWidth, b.scrollWidth)),
                    (d = b.getBoundingClientRect && b.getBoundingClientRect().width),
                    d < a && d >= a - 1 && (a = Math.floor(d)),
                    Math.max(0, a - c.getStyle(b, "padding-left") - c.getStyle(b, "padding-right"))
                );
        ...
        c.offset = function (b) {
            ...
            return { top: b.top + (g.pageYOffset || a.scrollTop) - (a.clientTop || 0), left: b.left + (g.pageXOffset || a.scrollLeft) - (a.clientLeft || 0) };
        };
        c.stop = function (b, a) {
            for (var d = c.timers.length; d--; ) c.timers[d].elem !== b || (a && a !== c.timers[d].prop) || (c.timers[d].stopped = !0);
        };
    ...
    N(H, "parts/Color.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.Color.prototype = {
            ...
            init: function (z) {
                var u, n;
                if ((this.input = z = this.names[z && z.toLowerCase ? z.toLowerCase() : ""] || z) && z.stops)
                    this.stops = z.stops.map(function (x) {
            ...
            brighten: function (c) {
                ...
                else if (A(c) && 0 !== c) for (u = 0; 3 > u; u++) (z[u] += D(255 * c)), 0 > z[u] && (z[u] = 0), 255 < z[u] && (z[u] = 255);
                return this;
            },
            ...
            tweenTo: function (c, u) {
                ...
                y.length && z && z.length
                    ? ((c = 1 !== y[3] || 1 !== z[3]),
                      (u =
                          (c ? "rgba(" : "rgb(") +
                          Math.round(y[0] + (z[0] - y[0]) * (1 - u)) +
                          "," +
                          Math.round(y[1] + (z[1] - y[1]) * (1 - u)) +
                          "," +
                          Math.round(y[2] + (z[2] - y[2]) * (1 - u)) +
                          (c ? "," + (y[3] + (z[3] - y[3]) * (1 - u)) : "") +
                          ")"))
                    : (u = c.input || "none");
                return u;
    ...
    N(H, "parts/SvgRenderer.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        E(M.prototype, {
            ...
            animate: function (a, b, d) {
                ...
                0 !== G.duration
                    ? (d && (G.complete = d), g(this, a, G))
                    : (this.attr(a, void 0, d),
                      C(
                          a,
                          function (a, b) {
            ...
            complexColor: function (a, b, d) {
                ...
                c.fireEvent(this.renderer, "complexColor", { args: arguments }, function () {
                    ...
                    w &&
                        ...
                        (t = a.stops),
                        (K = d.radialReference),
                        z(e) && (a[w] = e = { x1: e[0], y1: e[1], x2: e[2], y2: e[3], gradientUnits: "userSpaceOnUse" }),
                        "radialGradient" === w && K && !D(e.gradientUnits) && ((f = e), (e = B(e, G.getRadialAttr(K, f), { gradientUnits: "userSpaceOnUse" }))),
                        C(e, function (a, G) {
                            "id" !== G && Q.push(G, a);
                        }),
                        C(t, function (a) {
                        ...
                        k[Q]
                            ? (r = k[Q].attr("id"))
                            : ((e.id = r = c.uniqueKey()),
                              (k[Q] = O = G.createElement(w).attr(e).add(G.defs)),
                              (O.radAttr = f),
                              (O.stops = []),
            ...
            applyTextOutline: function (a) {
                ...
                if ((G = a[0]) && "none" !== G && c.svg) {
                    ...
                    a.forEach(function (a, l) {
                        ...
                        a = a.cloneNode(1);
                        A(a, { class: "highcharts-text-outline", fill: d, stroke: d, "stroke-width": G, "stroke-linejoin": "round" });
                        b.insertBefore(a, w);
                    });
                }
            },
            ...
            attr: function (a, b, d, l) {
                ...
                "string" === typeof a
                    ? (e = (this[a + "Getter"] || this._defaultGetter).call(this, a, G))
                    : (C(
                          a,
                          function (b, d) {
                              f = !1;
            ...
            getBBox: function (a, b) {
                ...
                if (!d) {
                    if (O || l.forExport) {
                        try {
                            (c =
                                ...
                                (d = G.getBBox ? E({}, G.getBBox()) : { width: G.offsetWidth, height: G.offsetHeight }),
                                c && c("");
                        } catch (Z) {
                            ("");
                        }
                    ...
                    l.isSVG &&
                        ((a = d.width),
                        (l = d.height),
                        O && (d.height = l = { "11px,17": 14, "13px,20": 16 }[f && f.fontSize + "," + Math.round(l)] || l),
                        b && ((d.width = Math.abs(l * Math.sin(B)) + Math.abs(a * Math.cos(B))), (d.height = Math.abs(l * Math.cos(B)) + Math.abs(a * Math.sin(B)))));
                    if (K && 0 < d.height) {
            ...
            destroy: function () {
                ...
                e &&
                    w &&
                    ([].forEach.call(w.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
            ...
            shadow: function (a, b, d) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    var G = w(a.width, 3);
                    var k = (a.opacity || 0.15) / G;
                    var c = this.parentInverted ? "(-1,-1)" : "(" + w(a.offsetX, 1) + ", " + w(a.offsetY, 1) + ")";
                    for (e = 1; e <= G; e++) {
                        var t = f.cloneNode(0);
                        var h = 2 * G + 1 - 2 * e;
                        A(t, { stroke: a.color || "#000000", "stroke-opacity": k * e, "stroke-width": h, transform: "translate" + c, fill: "none" });
        ...
        M.prototype.translateXSetter = M.prototype.translateYSetter = M.prototype.rotationSetter = M.prototype.verticalAlignSetter = M.prototype.rotationOriginXSetter = M.prototype.rotationOriginYSetter = M.prototype.scaleXSetter = M.prototype.scaleYSetter = M.prototype.matrixSetter = function (
            a,
            b
        ) {
            this[b] = a;
        ...
        M.prototype["stroke-widthSetter"] = M.prototype.strokeSetter = function (a, b, d) {
            ...
            this.stroke && this["stroke-width"]
                ? (M.prototype.fillSetter.call(this, this.stroke, "stroke", d), d.setAttribute("stroke-width", this["stroke-width"]), (this.hasStroke = !0))
        ...
        E(n.prototype, {
            ...
            init: function (a, b, l, w, e, f, k) {
                var c = this.createElement("svg").attr({ version: "1.1", class: "highcharts-root" });
                ...
                this.alignedObjects = [];
                this.url =
                    (v || t) && r.getElementsByTagName("base").length
                        ? S.location.href
                              .split("#")[0]
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                ...
                v &&
                    ...
                    b(),
                    (this.unSubPixelFix = p(S, "resize", b)));
            },
            ...
            buildText: function (a) {
                ...
                if (u !== a.textCache) {
                    ...
                    k || M || q || B || (-1 !== f.indexOf(" ") && (!v || S.test(f)))
                        ? (G && G.appendChild(b),
                          k
                              ? ((f = l.styledMode
                                    ? f.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">')
                                    : f.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">')),
                                (f = f
                                    .replace(/<a/g, "<span")
                                  ...
                                  if ("" !== w || 1 === G.length) {
                                      ...
                                      if (" " !== w) {
                                          ...
                                          if (B) {
                                              ...
                                              var x = E(M);
                                              if (q)
                                                  t = l.truncate(a, M, w, void 0, 0, Math.max(0, B - parseInt(I || 12, 10)), function (a, b) {
                                                  ...
                                                  for (; Q.length; )
                                                      Q.length &&
                                                          !v &&
                                                          0 < g &&
                                                          ((M = r.createElementNS(T, "tspan")), A(M, { dy: x, x: h }), O && A(M, "style", O), M.appendChild(r.createTextNode(Q.join(" ").replace(/- /g, "-"))), b.appendChild(M)),
                          ...
                          q && t && a.attr("title", p(a.textStr, ["&lt;", "&gt;"])),
                          G && G.removeChild(b),
                          M && a.applyTextOutline && a.applyTextOutline(M))
                        : b.appendChild(r.createTextNode(p(f)));
                }
            },
            ...
            button: function (a, b, d, l, w, e, f, c, t, h) {
                ...
                if (!K) {
                    w = B({ fill: "#f7f7f7", stroke: "#cccccc", "stroke-width": 1, style: { color: "#333333", cursor: "pointer", fontWeight: "normal" } }, w);
                    var M = w.style;
                    delete w.style;
                    e = B(w, { fill: "#e6e6e6" }, e);
                    var r = e.style;
                ...
                if (K) {
                    ...
                    ["width", "height"].forEach(function (a) {
                        q[a + "Setter"] = function (a, b) {
                            ...
                            this[b] = a;
                            D(l) &&
                                (t && "within" === t.backgroundSize && this.width && this.height && (l = Math.round(l * Math.min(this.width / this.imgwidth, this.height / this.imgheight))),
                                this.element && this.element.setAttribute(b, l),
                                this.alignByTranslate || ((d[w] = ((this[b] || 0) - l) / 2), this.attr(d)));
                        };
                    });
                    D(l) && q.attr({ x: l, y: e });
                    q.isImg = !0;
                    D(q.imgwidth) && D(q.imgheight)
                        ? I()
                        : (q.attr({ width: 0, height: 0 }),
                          f("img", {
                              onload: function () {
                                  var a = b[h.chartIndex];
                                  0 === this.width && (d(this, { position: "absolute", top: "-999em" }), r.body.appendChild(this));
            ...
            symbols: {
                circle: function (a, b, d, l) {
                    return this.arc(a + d / 2, b + l / 2, d / 2, l / 2, { start: 0.5 * Math.PI, end: 2.5 * Math.PI, open: !1 });
                },
                ...
                arc: function (a, b, d, l, e) {
                    var f = e.start,
                        ...
                        t = e.end - 0.001;
                    d = e.innerR;
                    l = w(e.open, 0.001 > Math.abs(e.end - e.start - 2 * Math.PI));
                    var h = Math.cos(f),
                        B = Math.sin(f),
                        J = Math.cos(t);
                    t = Math.sin(t);
                    f = 0.001 > e.end - f - Math.PI ? 0 : 1;
                ...
                callout: function (a, b, d, l, w) {
                    ...
                    k && k > d
                        ? w > b + f && w < b + l - f
                            ? c.splice(13, 3, "L", a + d, w - 6, a + d + 6, w, a + d, w + 6, a + d, b + l - e)
                            : c.splice(13, 3, "L", a + d, l / 2, k, w, a + d, l / 2, a + d, b + l - e)
                        : k && 0 > k
                        ? w > b + f && w < b + l - f
                            ? c.splice(33, 3, "L", a, w + 6, a - 6, w, a, w - 6, a, b + e)
                            : c.splice(33, 3, "L", a, l / 2, k, w, a, l / 2, a, b + e)
                        : w && w > l && k > a + f && k < a + d - f
                        ? c.splice(23, 3, "L", k + 6, b + l, k, b + l + 6, k - 6, b + l, a + e, b + l)
                        : w && 0 > w && k > a + f && k < a + d - f && c.splice(3, 3, "L", k - 6, b, k, b - 6, k + 6, b, d - e, b);
                    return c;
                },
            },
            clipRect: function (a, b, d, l) {
                var w = c.uniqueKey() + "-",
                    e = this.createElement("clipPath").attr({ id: w }).add(this.defs);
            ...
            label: function (a, b, d, w, e, f, k, c, t) {
                var h = this,
                    ...
                    q = (K.text = h.text("", 0, 0, k).attr({ zIndex: 1 })),
                    r,
                    v,
                    G = 0,
                    I = 3,
                ...
                var L = function () {
                    ...
                    y &&
                        (r ||
                            ((K.box = r = h.symbols[w] || z ? h.symbol(w) : h.rect()),
                            r.addClass(("button" === t ? "" : "highcharts-label-box") + (t ? " highcharts-" + t + "-box" : "")),
                            r.add(K),
                            (a = n()),
                            (b.x = a),
                            (b.y = (c ? -S : 0) + a)),
                        (b.width = Math.round(K.width)),
                        (b.height = Math.round(K.height)),
                        r.attr(E(b, Q)),
                        (Q = {}));
                };
                var C = function () {
                    var a = m + I;
                    var b = c ? 0 : S;
                    D(g) && v && ("center" === x || "right" === x) && (a += { center: 0.5, right: 1 }[x] * (g - v.width));
        ...
        L(p.prototype, {
            ...
            htmlUpdateTransform: function () {
                if (this.added) {
                    ...
                    this.inverted &&
                        [].forEach.call(a.childNodes, function (d) {
                            b.invertChild(d, a);
                        });
                    if ("SPAN" === a.tagName) {
                        q = this.rotation;
                        var k = this.textWidth && F(this.textWidth),
                            ...
                            B;
                        (B = k !== this.oldTextWidth) && !(B = k > this.oldTextWidth) && ((B = this.textPxLength) || (u(a, { width: "", whiteSpace: v || "nowrap" }), (B = a.offsetWidth)), (B = B > k));
                        B && (/[ \-]/.test(a.textContent || a.innerText) || "ellipsis" === a.style.textOverflow)
                            ? (u(a, { width: k + "px", display: "block", whiteSpace: v || "normal" }), (this.oldTextWidth = k), (this.hasBoxWidthChanged = !0))
                            : (this.hasBoxWidthChanged = !1);
                        t !== this.cTT &&
                            ((v = b.fontMetrics(a.style.fontSize, a).b),
                            !D(q) || (q === (this.oldRotation || 0) && r === this.oldAlign) || this.setSpanRotation(q, m, v),
                            this.getSpanCorrection((!D(q) && this.textPxLength) || a.offsetWidth, v, m, q, r));
            ...
            getSpanCorrection: function (b, a, d) {
                this.xCorr = -b * d;
                this.yCorr = -a;
            },
        });
    ...
    N(H, "parts/Time.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.Time.prototype = {
            ...
            update: function (c) {
                ...
                (this.variableTimezone = !(m && !c.getTimezoneOffset && !c.timezone)) || this.timezoneOffset
            ...
            resolveDTLFormat: function (c) {
                return D(c, !0) ? c : ((c = z(c)), { main: c[0], from: c[1], to: c[2] });
            },
                        ...
                        d.push(p),
                            (p =
                                h === C.year
                                    ...
                                    : !m || (h !== C.day && h !== C.week)
                                    ? m && h === C.hour && 1 < r
                                        ? a.makeTime(q, b, v, k + e * r)
                                        : p + h * r
                                    : a.makeTime(q, b, v + e * r * (h === C.day ? 1 : 7))),
                            e++;
                    d.push(p);
                    h <= C.hour &&
                        1e4 > d.length &&
    ...
    N(H, "parts/Options.js", [H["parts/Globals.js"]], function (c) {
        ...
        c.defaultOptions = { 
		    ...
		    colors: "#5f308a #5a6fd2 #7cb5ec #434348 #90ed7d #f7a35c #8085e9 #f15c80 #e4d354 #2b908f #f45b5b #91e8e1".split(" "),
            ...
            credits: { enabled: !0, href: "https://www.highcharts.com?credits", position: { align: "right", x: -10, verticalAlign: "bottom", y: -5 }, style: { cursor: "pointer", color: "#999999", fontSize: "9px" }, text: "CNFI" },
        };
    ...
    N(H, "parts/Tick.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.Tick.prototype = {
            addLabel: function () {
                ...
                x.isFirst = h;
                x.isLast = r;
                x.formatCtx = { axis: m, chart: g, isFirst: h, isLast: r, dateTimeLabelFormat: t, tickPositionInfo: e, value: m.isLog ? F(m.lin2log(b)) : b, pos: d };
                p = m.labelFormatter.call(x.formatCtx, this.formatCtx);
                if ((v = k && k.list))
                    x.shortenLabel = function () {
                ...
                if (A(E)) E && E.textStr !== p && (!E.textWidth || (f.style && f.style.width) || E.styles.width || E.css({ width: null }), E.attr({ text: p }), (E.textPxLength = E.getBBox().width));
                else {
            ...
            handleOverflow: function (c) {
                ...
                var f = this.label,
                    e = this.rotation,
                    h = { left: 0, center: 0.5, right: 1 }[m.labelAlign || f.attr("align")],
                    r = f.getBBox().width,
                    ...
                    k,
                    t = {};
                if (e || "justify" !== y(p.overflow, "justify")) 0 > e && g - h * r < d ? (k = Math.round(g / Math.cos(e * C) - d)) : 0 < e && g + h * r > a && (k = Math.round((b - g) / Math.cos(e * C)));
                else if (
                    ((b = g + (1 - h) * r),
                    g - h * r < d ? (q = c.x + q * (1 - h) - d) : b > a && ((q = a - c.x + q * h), (v = -1)),
                    (q = Math.min(E, q)),
                    q < E && "center" === m.labelAlign && (c.x += v * (E - q - h * (E - Math.min(r, q)))),
                    r > q || (m.autoRotation && (f.styles || {}).width))
                )
                    k = q;
            ...
            getLabelPosition: function (c, m, p, g, b, a, d, f) {
                var e = this.axis,
                    ...
                    E = e.staggerLines,
                    q = e.tickRotCorr || { x: 0, y: 0 },
                    v = b.y,
                    k = g || e.reserveSpaceDefault ? 0 : -e.labelOffset * ("center" === e.labelAlign ? 0.5 : 1),
                    t = {};
            ...
            renderGridLine: function (c, m, p) {
                ...
                b = b[E + "LineDashStyle"];
                a ||
                    (g.chart.styledMode || ((d.stroke = v), (d["stroke-width"] = q), b && (d.dashstyle = b)),
                    e || (d.zIndex = 1),
                    c && (m = 0),
                    (this.gridLine = a = r
                        .path()
                        .attr(d)
                        .addClass("highcharts-" + (e ? e + "-" : "") + "grid-line")
                        .add(g.gridGroup)));
                if (a && (p = g.getPlotLinePath({ value: f + h, lineWidth: a.strokeWidth() * p, force: "pass", old: c }))) a[c || this.isNew ? "attr" : "animate"]({ d: p, opacity: m });
            },
                ...
                e &&
                    ...
                    r &&
                        ((this.mark = h = a
                            ...
                            .add(g.axisGroup)),
                        g.chart.styledMode || h.attr({ stroke: b, "stroke-width": q })),
                    h[r ? "attr" : "animate"]({ d: this.getMarkPath(E, c, e[0], h.strokeWidth() * p, g.horiz, a), opacity: m }));
            },
            renderLabel: function (c, m, p, g) {
                ...
                f &&
                    D(E) &&
                    ((f.xy = c = this.getLabelPosition(E, c, f, a, e, b, g, h)),
                    (this.isFirst && !this.isLast && !y(d.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !y(d.showLastLabel, 1)) ? (r = !1) : !a || e.step || e.rotation || m || 0 === p || this.handleOverflow(c),
                    h && g % h && (r = !1),
                    r && D(c.y) ? ((c.opacity = p), f[this.isNewLabel ? "attr" : "animate"](c), (this.isNewLabel = !1)) : (f.attr("y", -9999), (this.isNewLabel = !0)));
            },
    ...
    N(H, "parts/Axis.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.extend(n.prototype, {
            ...
            defaultLabelFormatter: function () {
                ...
                else if (r && 1e3 <= a) for (; r-- && void 0 === v; ) (e = Math.pow(t, r + 1)), a >= e && 0 === (10 * d) % e && null !== B[r] && 0 !== d && (v = c.numberFormat(d / e, -1) + B[r]);
                    ...
                    a.series.forEach(function (l) {
                        if (l.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) {
                                ...
                                (c = l.dataMax),
                                (f = l.dataMin),
                                A(f) && A(c) && ((a.dataMin = Math.min(v(a.dataMin, f), f)), (a.dataMax = Math.max(v(a.dataMax, c), c))),
                                A(w) && (a.threshold = w),
            ...
            translate: function (a, b, d, e, f, c) {
            ...
            getMinorTickPositions: function () {
                ...
                if (t && t / e < a.len / 3)
                    if (a.isLog)
                        this.paddedTicks.forEach(function (b, d, l) {
            ...
            updateNames: function () {
                var a = this,
                    b = this.names;
                0 < b.length &&
                    (Object.keys(b.keys).forEach(function (a) {
                        delete b.keys[a];
                    }),
                    (b.length = 0),
            ...
            setAxisTranslation: function (a) {
                ...
                if (r || h || f) {
                    var q = b.getClosest();
                    k
                        ? ((c = k.minPointOffset), (w = k.pointRangePadding))
            ...
            setTickInterval: function (a) {
                ...
                u &&
                    A(b.dataMin) &&
                    ((x = x || 0),
                    !A(z) && b.min < x && b.dataMin >= x ? (b.min = b.options.minRange ? Math.min(x, b.max - b.minRange) : x) : !A(y) && b.max > x && b.dataMax <= x && (b.max = b.options.minRange ? Math.max(x, b.min + b.minRange) : x));
                b.tickInterval =
                    b.min === b.max || void 0 === b.min || void 0 === b.max
                        ? 1
                        : h && !m && p === b.linkedParent.options.tickPixelInterval
                        ? (m = b.linkedParent.tickInterval)
                        : v(m, this.tickAmount ? (b.max - b.min) / Math.max(this.tickAmount - 1, 1) : void 0, E ? 1 : ((b.max - b.min) * p) / Math.max(b.len, p));
                t &&
                    !a &&
                    b.series.forEach(function (a) {
                ...
                k || w || m || (b.tickInterval = q(b.tickInterval, null, r(b.tickInterval), v(f.allowDecimals, !(0.5 < b.tickInterval && 5 > b.tickInterval && 1e3 < b.max && 9999 > b.max)), !!this.tickAmount));
            ...
            setTickPositions: function () {
                ...
                !d &&
                    ...
                    (this.tickPositions = d = f);
                this.paddedTicks = d.slice(0);
                this.trimTicks(d, k, t);
                this.isLinked || (this.single && 2 > d.length && !this.categories && ((this.min -= 0.5), (this.max += 0.5)), b || f || this.adjustTickAmount());
            ...
            adjustTickAmount: function () {
                ...
                if (this.hasData()) {
                    if (c < f) {
                        for (t = this.min; d.length < f; ) d.length % 2 || t === k ? d.push(g(d[d.length - 1] + b)) : d.unshift(g(d[0] - b));
                        this.transA *= (c - 1) / (f - 1);
            ...
            zoom: function (a, b) {
                ...
                e(this, "zoom", a, function (a) {
                    var b = a.newMin,
                        e = a.newMax;
                    if (b !== this.min || e !== this.max)
                        this.allowZoomOutside || (A(d) && (b < k && (b = k), b > l && (b = l)), A(f) && (e < k && (e = k), e > l && (e = l))),
                            (this.displayBtn = void 0 !== b || void 0 !== e),
                            this.setExtremes(b, e, !1, void 0, { trigger: "zoom" });
                    a.zoomed = !0;
                });
                return a.zoomed;
            },
            ...
            getExtremes: function () {
                var a = this.isLog;
                return { min: a ? g(this.lin2log(this.min)) : this.min, max: a ? g(this.lin2log(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax };
            },
            ...
            unsquish: function () {
                ...
                d
                    ? (q = !b.staggerLines && !b.step && (A(t) ? [t] : c < v(b.autoRotationLimit, 80) && b.autoRotation)) &&
            ...
            getSlotWidth: function (a) {
                var b = this.chart,
                    ...
                    c = b.margin[3];
                return (a && a.slotWidth) || (d && 2 > (f.step || 0) && !f.rotation && ((this.staggerLines || 1) * this.len) / e) || (!d && ((f.style && parseInt(f.style.width, 10)) || (c && c - b.spacing[3]) || 0.33 * b.chartWidth));
            },
            renderUnsquish: function () {
                ...
                if (this.autoRotation) v > h && v > r.h ? (B.rotation = this.labelRotation) : (this.labelRotation = 0);
                    ...
                    if (!q) {
                        ...
                        for (h = d.length; !k && h--; ) {
                            var g = d[h];
                            if ((g = f[g].label))
                                g.styles && "ellipsis" === g.styles.textOverflow ? g.css({ textOverflow: "clip" }) : g.textPxLength > t && g.css({ width: t + "px" }),
                                    g.getBBox().height > this.len / d.length - (r.h - r.f) && (g.specificTextOverflow = "ellipsis");
                        }
                    }
                }
                B.rotation && ((I = v > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : v), q || (m = "ellipsis"));
                ...
                d.forEach(function (a) {
                    ...
                    b &&
                        ...
                        a.shortenLabel
                            ? a.shortenLabel()
                            : I && !d && "nowrap" !== c.whiteSpace && (I < b.textPxLength || "SPAN" === b.element.tagName)
                            ? ((e.width = I), q || (e.textOverflow = b.specificTextOverflow || m), b.css(e))
                            : b.styles && b.styles.width && !e.width && !d && b.css({ width: null }),
            ...
            addTitle: function (a) {
                ...
                this.axisTitle ||
                    ((c = e.textAlign) || (c = (d ? { low: "left", middle: "center", high: "right" } : { low: f ? "right" : "left", middle: "center", high: f ? "left" : "right" })[e.align]),
                    (this.axisTitle = b
                        .text(e.text, 0, 0, e.useHTML)
                        .attr({ zIndex: 7, rotation: e.rotation || 0, align: c })
                        .addClass("highcharts-axis-title")),
                    k || this.axisTitle.css(E(e.style)),
            ...
            getOffset: function () {
                ...
                a.axisGroup ||
                    ((a.gridGroup = d
                        ...
                        .addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (z || ""))
                        .add(y)),
                    (a.axisGroup = d
                        .g("axis")
                        .attr({ zIndex: f.zIndex || 2 })
                        .addClass("highcharts-" + this.coll.toLowerCase() + " " + (z || ""))
                        .add(y)),
                    (a.labelGroup = d
                        .g("axis-labels")
                        .attr({ zIndex: g.zIndex || 7 })
                        .addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (z || ""))
                        .add(y)));
                n || a.isLinked
                    ? (c.forEach(function (b, d) {
                      ...
                      a.renderUnsquish(),
                      (a.reserveSpaceDefault = 0 === h || 2 === h || { 1: "left", 3: "right" }[h] === a.labelAlign),
                      v(g.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
            ...
            getTitlePosition: function () {
                ...
                a = { x: a ? f + B : b + (t ? this.width : 0) + h + B, y: a ? b + r - (t ? this.height : 0) + h : f + r };
            ...
            render: function () {
                ...
                if (a.hasData() || k)
                    a.minorTickInterval &&
                        !a.categories &&
                        a.getMinorTickPositions().forEach(function (b) {
                            a.renderMinorTick(b);
                        }),
                        t.length &&
                            ...
                            p && (0 === a.min || a.single) && (r[-1] || (r[-1] = new I(a, -1, null, !0)), r[-1].render(-1))),
                        g &&
                            t.forEach(function (d, e) {
                                n = void 0 !== t[e + 1] ? t[e + 1] + p : a.max - p;
                                0 === e % 2 &&
                                    d < a.max &&
                                    n <= a.max + (b.polar ? -p : p) &&
                                    (v[d] || (v[d] = new c.PlotLineOrBand(a)), (y = d + p), (v[d].options = { from: f ? a.lin2log(y) : y, to: f ? a.lin2log(n) : n, color: g }), v[d].render(), (v[d].isActive = !0));
                            }),
                        a._addedPlotLB ||
                            ((d.plotLines || []).concat(d.plotBands || []).forEach(function (b) {
            ...
            drawCrosshair: function (a, b) {
                ...
                if (this.crosshair && !1 !== (A(b) || !c)) {
                    ...
                    A(k) && (d = this.getPlotLinePath({ value: b && (this.isXAxis ? b.x : v(b.stackY, b.y)), translatedValue: k }) || null);
                    if (!A(d)) {
                        this.hideCrosshair();
                        return;
                    }
                    ...
                    l ||
                        ((this.cross = l = this.chart.renderer
                            .path()
                            .addClass("highcharts-crosshair highcharts-crosshair-" + (c ? "category " : "thin ") + f.className)
                            .attr({ zIndex: v(f.zIndex, 2) })
                            .add()),
                        this.chart.styledMode ||
                            (l.attr({ stroke: f.color || (c ? p("#ccd6eb").setOpacity(0.25).get() : "#cccccc"), "stroke-width": v(f.width, 1) }).css({ "pointer-events": "none" }), f.dashStyle && l.attr({ dashstyle: f.dashStyle })));
                    l.show().attr({ d: d });
    ...
    N(H, "parts/LogarithmicAxis.js", [H["parts/Globals.js"]], function (c) {
        ...
        n.prototype.getLogTickPositions = function (c, u, n, y) {
            ...
            if (0.5 <= c) (c = Math.round(c)), (m = this.getLinearTickPositions(c, u, n));
            else if (0.08 <= c) {
                x = Math.floor(u);
                var p, g;
                for (z = 0.3 < c ? [1, 2, 4] : 0.15 < c ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; x < n + 1 && !g; x++) {
                    var b = z.length;
                    for (p = 0; p < b && !g; p++) {
                ...
                (u = this.lin2log(u)),
                    (n = this.lin2log(n)),
                    (c = y ? this.getMinorTickInterval() : z.tickInterval),
                    (c = F("auto" === c ? null : c, this._minorAutoInterval, ((z.tickPixelInterval / (y ? 5 : 1)) * (n - u)) / ((y ? x / this.tickPositions.length : x) || 1))),
                    (c = D(c, null, A(c))),
                    (m = this.getLinearTickPositions(c, u, n).map(this.log2lin)),
    ...
    N(H, "parts/PlotLineOrBand.js", [H["parts/Globals.js"], H["parts/Axis.js"], H["parts/Utilities.js"]], function (c, n, A) {
        ...
        c.PlotLineOrBand.prototype = {
            render: function () {
                ...
                p.chart.styledMode ||
                    (E
                        ? ((k.stroke = t || "#999999"), (k["stroke-width"] = x(b.width, 1)), b.dashStyle && (k.dashstyle = b.dashStyle))
                        : r && ((k.fill = t || "#e6ebf5"), b.borderWidth && ((k.stroke = b.borderColor), (k["stroke-width"] = b.borderWidth))));
                w.zIndex = B;
                J += "-" + B;
                (t = p.plotLinesAndBandsGroups[J]) ||
                    (p.plotLinesAndBandsGroups[J] = t = l
                        .g("plot-" + J)
                        .attr(w)
                        .add());
                v && (m.svgElem = q = l.path().attr(k).add(t));
                if (E) k = p.getPlotLinePath({ value: h, lineWidth: q.strokeWidth(), acrossPanes: b.acrossPanes });
                ...
                (v || !q.d) && k && k.length
                    ...
                    : q && (k ? (q.show(!0), q.animate({ d: k })) : q.d && (q.hide(), d && (m.label = d = d.destroy())));
                a && (D(a.text) || D(a.formatter)) && k && k.length && 0 < p.width && 0 < p.height && !k.isFlat
                    ? ((a = C({ align: g && r && "center", x: g ? !r && 4 : 10, verticalAlign: !g && r && "middle", y: g ? (r ? 16 : 10) : r ? 6 : -4, rotation: g && !r && 90 }, a)), this.renderLabel(a, k, r, B))
                    : d && d.hide();
                return m;
            },
            renderLabel: function (c, p, g, b) {
                ...
                a ||
                    ((a = { align: c.textAlign || c.align, rotation: c.rotation, class: "highcharts-plot-" + (g ? "band" : "line") + "-label " + (c.className || "") }),
                    (a.zIndex = b),
                    (b = this.getLabelText(c)),
                    (this.label = a = d.text(b, 0, 0, c.useHTML).attr(a).add()),
                    this.axis.chart.styledMode || a.css(c.style));
        ...
        c.extend(n.prototype, {
            getPlotBandPath: function (c, p) {
                var g = this.getPlotLinePath({ value: p, force: !0, acrossPanes: this.options.acrossPanes }),
                    b = this.getPlotLinePath({ value: c, force: !0, acrossPanes: this.options.acrossPanes }),
                    a = [],
                    d = this.horiz,
                    f = 1;
                ...
                if (b && g) {
                    ...
                    for (c = 0; c < b.length; c += 6)
                        d && g[c + 1] === b[c + 1] ? ((g[c + 1] += f), (g[c + 4] += f)) : d || g[c + 2] !== b[c + 2] || ((g[c + 2] += f), (g[c + 5] += f)),
    ...
    N(H, "parts/Tooltip.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.Tooltip.prototype = {
            ...
            getLabel: function () {
                ...
                if (!this.label) {
                    this.outside &&
                        ((this.container = e = c.doc.createElement("div")),
                        (e.className = "highcharts-tooltip-container"),
                        c.css(e, { position: "absolute", top: "1px", pointerEvents: d.style && d.style.pointerEvents, zIndex: 3 }),
                        c.doc.body.appendChild(e),
                        (this.renderer = b = new c.Renderer(e, 0, 0, {}, void 0, void 0, b.styledMode)));
                    this.split
                        ? (this.label = b.g(f))
                        : ((this.label = b.label("", 0, 0, d.shape || "callout", null, null, d.useHTML, null, f).attr({ padding: d.padding, r: d.borderRadius })),
                          a || this.label.attr({ fill: d.backgroundColor, "stroke-width": d.borderWidth }).css(d.style).shadow(d.shadow));
            ...
            move: function (g, b, a, d) {
                ...
                L(e, { x: h ? (2 * e.x + g) / 3 : g, y: h ? (e.y + b) / 2 : b, anchorX: r ? void 0 : h ? (2 * e.anchorX + a) / 3 : a, anchorY: r ? void 0 : h ? (e.anchorY + d) / 2 : d });
                f.getLabel().attr(e);
                h &&
                    (c.clearTimeout(this.tooltipTimeout),
            ...
            getAnchor: function (c, b) {
                ...
                this.followPointer && b
                    ? (void 0 === b.chartX && (b = d.normalize(b)), (c = [b.chartX - a.plotLeft, b.chartY - e]))
                    : c[0].tooltipPos
                    ? (c = c[0].tooltipPos)
                    : (c.forEach(function (a) {
                          q = a.series.yAxis;
                      ...
                      (r /= c.length),
                      (g /= c.length),
                      (c = [f ? a.plotWidth - g : r, this.shared && !f && 1 < c.length && b ? b.chartY - e : f ? a.plotHeight - r : g]));
            ...
            getPosition: function (c, b, a) {
                var d = this.chart,
                    ...
                    w = function (e) {
                        var l = "x" === e;
                        return [e, l ? q : v, l ? c : b].concat(
                            g
                                ? [l ? B(c) : I(b), l ? k.left - f + B(a.plotX + d.plotLeft) : k.top - f + I(a.plotY + d.plotTop), 0, l ? q : v]
                                : [l ? c : b, l ? a.plotX + d.plotLeft : a.plotY + d.plotTop, l ? d.plotLeft : d.plotTop, l ? d.plotLeft + d.plotWidth : d.plotTop + d.plotHeight]
                        );
                    },
                    l = w("y"),
                    m = w("x"),
            ...
            refresh: function (g, b) {
                ...
                if (d.enabled) {
                    ...
                    b = q[0];
                    var v = q[1];
                    !e || (f.series && f.series.noSharedTooltip)
                        ? (e = f.getLabelConfig())
                        : (a.pointer.applyInactiveState(f),
                          f.forEach(function (a) {
                              a.setState("hover");
                              h.push(a.getLabelConfig());
                          }),
                          (e = { x: f[0].category, y: f[0].y }),
                          (e.points = h),
                          (f = f[0]));
                    this.len = h.length;
                    r = r.call(e, this);
                    ...
                    !1 === r
                        ? this.hide()
                        : ((a = this.getLabel()),
                          this.isHidden && a.attr({ opacity: 1 }).show(),
                          this.split
                              ? this.renderSplit(r, z(g))
                              : ((d.style.width && !m) || a.css({ width: this.chart.spacingBox.width }),
                                a.attr({ text: r && r.join ? r.join("") : r }),
                                a.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + x(f.colorIndex, e.colorIndex)),
                                m || a.attr({ stroke: d.borderColor || f.color || e.color || "#666666" }),
                                this.updatePosition({ plotX: b, plotY: v, negative: f.negative, ttBelow: f.ttBelow, h: q[2] || 0 })),
                          (this.isHidden = !1));
            ...
            renderSplit: function (g, b) {
                ...
                g.slice(0, b.length + 1).forEach(function (c, B) {
                    if (!1 !== c && "" !== c) {
                        ...
                        w ||
                            ((w = { padding: r.padding, r: r.borderRadius }),
                            f.styledMode || ((w.fill = r.backgroundColor), (w["stroke-width"] = r.borderWidth)),
                            (t.tt = w = e
                                .label(null, null, null, (B.isHeader ? r.headerShape : r.shape) || "callout", null, null, r.useHTML)
                        ...
                        f.styledMode ||
                            w
                                .css(r.style)
                                .shadow(r.shadow)
                                .attr({ stroke: r.borderColor || B.color || l.color || "#333333" });
                        c = w.getBBox();
                        g = c.width + w.strokeWidth();
                        B.isHeader
                            ? ((m = c.height), f.xAxis[0].opposite && ((q = !0), (k -= m)), (c = Math.max(0, Math.min(B.plotX + f.plotLeft - g / 2, f.chartWidth + (f.scrollablePixelsX ? f.scrollablePixelsX - f.marginRight : 0) - g))))
                            : (c = B.plotX + f.plotLeft - x(r.distance, 16) - g);
                        0 > c && (h = !1);
                        B.isHeader ? (l = q ? -m : f.plotHeight + m) : ((l = l.yAxis), (l = l.pos - k + Math.max(0, Math.min(B.plotY || 0, l.len))));
                        d.push({ target: l, rank: B.isHeader ? 1 : 0, size: t.tt.getBBox().height + 1, point: B, x: c, tt: w });
                    }
                });
                this.cleanSplit();
                r.positioner &&
            ...
            updatePosition: function (g) {
                ...
                if (this.outside) {
                    ...
                    if ((b = b.containerScaling)) c.css(this.container, { transform: "scale(" + b.scaleX + ", " + b.scaleY + ")" }), (f *= b.scaleX), (e *= b.scaleY);
        ...
        c.Pointer.prototype = {
            ...
            getChartCoordinatesFromPoint: function (a, b) {
                ...
                var e = d(a.clientX, a.plotX),
                    h = a.shapeArgs;
                if (f && c) return b ? { chartX: f.len + f.pos - e, chartY: c.len + c.pos - a.plotY } : { chartX: e + f.pos, chartY: a.plotY + c.pos };
            ...
            runPointActions: function (a, b) {
                ...
                if (v && (v !== f.hoverPoint || (e && e.isHidden))) {
                    ...
                    f.hoverPoint = v;
                    e && e.refresh(h ? t : v, a);
                } else b && e && !e.isHidden && ((v = e.getAnchor([{}], a)), e.updatePosition({ plotX: v[0], plotY: v[1] }));
                this.unDocMouseMove ||
                    (this.unDocMouseMove = y(f.container.ownerDocument, "mousemove", function (a) {
                ...
                if (!l || !l.touch)
                    if ((c < t ? (c = t) : c > t + I && (c = t + I), f < B ? (f = B) : f > B + w && (f = B + w), (this.hasDragged = Math.sqrt(Math.pow(g - c, 2) + Math.pow(m - f, 2))), 10 < this.hasDragged)) {
                        ...
                        b.hasCartesianSeries &&
                            ...
                            !p &&
                            !l &&
                            ((this.selectionMarker = l = b.renderer
                                .rect(t, B, e ? 1 : I, k ? 1 : w, 0)
                                .attr({ class: "highcharts-selection-marker", zIndex: 7 })
                                .add()),
                            b.styledMode || l.attr({ fill: d.selectionMarkerFill || x("#335cad").setOpacity(0.25).get() }));
                ...
                if (this.selectionMarker) {
                    ...
                    if (this.hasDragged || f)
                        c.axes.forEach(function (b) {
                            ...
                            w &&
                                b(c, "selection", e, function (a) {
                                    c.zoom(p(a, f ? { animation: !1 } : null));
                                });
            ...
            onContainerClick: function (a) {
                ...
                d.cancelClick ||
                    (c && this.inClass(a.target, "highcharts-tracker")
                        ? (b(c.series, "click", p(a, { point: c })), d.hoverPoint && c.firePointEvent("click", a))
                        : (p(a, this.getCoordinates(a)), d.isInsidePlot(a.chartX - f, a.chartY - e) && b(d, "click", a)));
            },
    ...
    N(H, "parts/TouchPointer.js", [H["parts/Globals.js"]], function (c) {
        ...
        A(c.Pointer.prototype, {
            ...
            pinchTranslateDirection: function (c, u, n, y, A, x, m, p) {
                ...
                l ? ((B -= 0.8 * (B - m[b][0])), k || (w -= 0.8 * (w - m[b][1])), n()) : (m[b] = [B, w]);
                q || ((x[b] = r - e), (x[f] = h));
                x = q ? 1 / E : E;
                A[f] = h;
                A[b] = u;
            ...
            pinch: function (c) {
                ...
                "touchstart" === c.type
                    ? ([].forEach.call(z, function (a, b) {
                          y[b] = { chartX: a.chartX, chartY: a.chartY };
                      }),
                      (m.x = [y[0].chartX, y[1] && y[1].chartX]),
                      (m.y = [y[0].chartY, y[1] && y[1].chartY]),
                      ...
                      (u.res = !0))
                    : u.followTouchMove && 1 === x
                    ? this.runPointActions(u.normalize(c))
                    : y.length && (g || (u.selectionMarker = g = A({ destroy: D, touch: !0 }, n.plotBox)), u.pinchTranslate(y, z, b, g, d, m), (u.hasPinched = p), u.scaleGroups(b, d), u.res && ((u.res = !1), this.reset(!1, 0)));
            },
            touch: function (n, u) {
                var z = this.chart,
                    y;
    ...
    N(H, "parts/MSPointer.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        if (!c.hasTouch && (x.PointerEvent || x.MSPointerEvent)) {
            var p = {},
                ...
                a = function (a, f, e, h) {
                    ("touch" !== a.pointerType && a.pointerType !== a.MSPOINTER_TYPE_TOUCH) || !F[c.hoverChartIndex] || (h(a), (h = F[c.hoverChartIndex].pointer), h[f]({ type: e, target: a.currentTarget, preventDefault: L, touches: b() }));
                };
            n(y.prototype, {
    ...
    N(H, "parts/Legend.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.Legend.prototype = {
            init: function (a, b) {
                ...
                b.enabled &&
                    (this.render(),
                    F(this.chart, "endResize", function () {
                        this.legend.positionCheckboxes();
                    }),
                    this.proximate
                        ? (this.unchartrender = F(this.chart, "render", function () {
            ...
            positionItem: function (a) {
                ...
                e = e[1];
                var r = a.checkbox;
                if ((a = a.legendGroup) && a.element) a[A(a.translateY) ? "animate" : "attr"]({ translateX: b ? h : this.legendWidth - h - 2 * c - 4, translateY: e });
                r && ((r.x = h), (r.y = e));
            },
                ...
                if (a) {
                    ...
                    this.allItems.forEach(function (d) {
                        ...
                        if (f) {
                            ...
                            z(f, { left: a.translateX + d.checkboxOffset + f.x - 20 + "px", top: h + "px", display: this.proximate || (h > e - 6 && h < e + b - 6) ? "" : "none" });
                        }
                    }, this);
                }
            },
            renderTitle: function () {
                ...
                c.text &&
                    (this.title ||
                        ((this.title = this.chart.renderer.label(c.text, b - 3, b - 4, null, null, null, a.useHTML, null, "legend-title").attr({ zIndex: 1 })), this.chart.styledMode || this.title.css(c.style), this.title.add(this.group)),
            ...
            renderItem: function (a) {
                ...
                t ||
                    ((a.legendGroup = c
                        .g("legend-item")
                        .addClass("highcharts-" + I.type + "-series highcharts-color-" + a.colorIndex + (m ? " " + m : "") + (B ? " highcharts-series-" + a.index : ""))
                        .attr({ zIndex: 1 })
                        .add(this.scrollGroup)),
                    (a.legendItem = t = c.text("", k ? h + r : -r, this.baseline || 0, l)),
                    b.styledMode || t.css(C(a.visible ? g : q)),
                    t.attr({ align: k ? "left" : "right", zIndex: 2 }).add(a.legendGroup),
                    this.baseline || ((this.fontMetrics = c.fontMetrics(b.styledMode ? 12 : g.fontSize, t)), (this.baseline = this.fontMetrics.f + 3 + this.itemMarginTop), t.attr("y", this.baseline)),
                    (this.symbolHeight = e.symbolHeight || this.fontMetrics.f),
                    I.drawLegendSymbol(this, a),
                    this.setItemEvents && this.setItemEvents(a, t, l));
            ...
            adjustMargins: function (a, b) {
                var d = this.chart,
                    ...
                    h = this.getAlignment();
                h &&
                    [/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/].forEach(function (f, e) {
            ...
            proximatePositions: function () {
                ...
                this.allItems.forEach(function (d) {
                    ...
                    if (d.yAxis && d.points) {
                        ...
                        d.visible ? ((g = g ? g.plotY : d.yAxis.height), (g += m - 0.3 * e)) : (g = m + d.yAxis.height);
            ...
            render: function () {
                ...
                a.styledMode || h.attr({ stroke: g.borderColor, "stroke-width": g.borderWidth || 0, fill: g.backgroundColor || "none" }).shadow(g.shadow);
                0 < q && 0 < v && (h[h.isNew ? "attr" : "animate"](h.crisp.call({}, { x: 0, y: 0, width: q, height: v }, h.strokeWidth())), (h.isNew = !1));
                h[e ? "show" : "hide"]();
                ...
                e &&
                    ((b = a.spacingBox),
                    (h = b.y),
                    /(lth|ct|rth)/.test(this.getAlignment()) && 0 < a.titleOffset[0] ? (h += a.titleOffset[0]) : /(lbh|cb|rbh)/.test(this.getAlignment()) && 0 < a.titleOffset[2] && (h -= a.titleOffset[2]),
                    h !== b.y && (b = C(b, { y: h })),
                    f.align(C(g, { width: q, height: v, verticalAlign: this.proximate ? "top" : g.verticalAlign }), !0, b));
            ...
            handleOverflow: function (a) {
                ...
                l.length = 0;
                a > g && !1 !== t.enabled
                    ? ((this.clipHeight = v = Math.max(g - 20 - this.titleHeight - m, 0)),
                      ...
                      k || ((k = b.clipRect = e.clipRect(0, m, 9999, 0)), b.contentGroup.clip(k)),
                      n(v),
                      w ||
                          ((this.nav = w = e.g().attr({ zIndex: 1 }).add(this.group)),
                          (this.up = e.symbol("triangle", 0, 0, I, I).add(w)),
                          u("upTracker").on("click", function () {
                              b.scroll(-1, B);
                          }),
                          (this.pager = e.text("", 15, 10).addClass("highcharts-legend-navigation")),
                          c.styledMode || this.pager.css(t.style),
                          this.pager.add(w),
                          (this.down = e.symbol("triangle-down", 0, 0, I, I).add(w)),
                          u("downTracker").on("click", function () {
                              b.scroll(1, B);
                          })),
                      b.scroll(0),
                      (a = g))
                    : w && (n(), (this.nav = w.destroy()), this.scrollGroup.attr({ translateY: 1 }), (this.clipHeight = 0));
                return a;
            },
            scroll: function (a, b) {
                var d = this.pages,
                ...
                h > c && (h = c);
                0 < h &&
                    (void 0 !== b && m(b, this.chart),
                    this.nav.attr({ translateX: q, translateY: a + this.padding + 7 + this.titleHeight, visibility: "visible" }),
                    [this.up, this.upTracker].forEach(function (a) {
                        a.attr({ class: 1 === h ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                    }),
                    p.attr({ text: h + "/" + c }),
                    [this.down, this.downTracker].forEach(function (a) {
                        a.attr({ x: 18 + this.pager.getBBox().width, class: h === c ? "highcharts-legend-nav-inactive" : "highcharts-legend-nav-active" });
                    }, this),
                    this.chart.styledMode ||
                        (this.up.attr({ fill: 1 === h ? g.inactiveColor : g.activeColor }),
                        this.upTracker.css({ cursor: 1 === h ? "default" : "pointer" }),
                        this.down.attr({ fill: h === c ? g.inactiveColor : g.activeColor }),
                        this.downTracker.css({ cursor: h === c ? "default" : "pointer" })),
                    (this.scrollOffset = -d[h - 1] + this.initialItemY),
        ...
        c.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                ...
                b.legendSymbol = this.chart.renderer
                    .rect(c ? (a.symbolWidth - d) / 2 : 0, a.baseline - d + 1, c ? d : a.symbolWidth, d, x(a.options.symbolRadius, d / 2))
            ...
            drawLineMarker: function (a) {
                ...
                c &&
                    !1 !== c.enabled &&
                    e &&
                    ((b = Math.min(x(c.radius, g), g)),
                    0 === this.symbol.indexOf("url") && ((c = C(c, { width: h, height: h })), (b = 0)),
                    (this.legendSymbol = c = m
                        .symbol(this.symbol, e / 2 - b, a - b, 2 * b, 2 * b, c)
                        .addClass("highcharts-point")
                        .add(q)),
                    (c.isMarker = !0));
            },
        };
        (/Trident\/7\.0/.test(g.navigator && g.navigator.userAgent) || n) &&
            b(c.Legend.prototype, "positionItem", function (a, b) {
                var d = this,
                    c = function () {
    ...
    N(H, "parts/Chart.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        q(S.prototype, {
            ...
            applyDescription: function (a, b) {
                ...
                c &&
                    ...
                    ((f = this.renderer
                        ...
                        .attr({ align: c.align, class: "highcharts-" + a, zIndex: c.zIndex || 4 })
                        .add()),
                    (f.update = function (b) {
            ...
            temporaryDisplay: function (b) {
                var d = this.renderTo;
                if (b) for (; d && d.style; ) d.hcOrigStyle && (c.css(d, d.hcOrigStyle), delete d.hcOrigStyle), d.hcOrigDetached && (a.body.removeChild(d), (d.hcOrigDetached = !1)), (d = d.parentNode);
                else
                    for (; d && d.style; ) {
                        a.body.contains(d) || d.parentNode || ((d.hcOrigDetached = !0), a.body.appendChild(d));
                        if ("none" === c.getStyle(d, "display", !1) || d.hcOricDetached)
                            (d.hcOrigStyle = { display: d.style.display, height: d.style.height, overflow: d.style.overflow }),
                                (b = { display: "block", overflow: "hidden" }),
                                d !== this.renderTo && (b.height = 0),
                                c.css(d, b),
            ...
            getContainer: function () {
                ...
                E(e, { overflow: "hidden" });
                this.styledMode || (t = q({ position: "relative", overflow: "hidden", width: B + "px", height: w + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, d.style));
                this.container = e = f("div", { id: l }, t, e);
                ...
                if (this.styledMode) for (h in b.defs) this.renderer.definition(b.defs[h]);
            ...
            reflow: function (b) {
                ...
                if (!k && !d.isPrinting && l && f && (e === R || e === a)) {
                    if (l !== d.containerWidth || f !== d.containerHeight)
                        c.clearTimeout(d.reflowTimeout),
                            (d.reflowTimeout = T(
                                function () {
            ...
            setReflow: function (a) {
                ...
                !1 === a || this.unbindReflow
                    ...
                    : ((this.unbindReflow = p(R, "resize", function (a) {
            ...
            setChartSize: function (a) {
                ...
                this.clipBox = { x: b, y: d, width: Math.floor(this.plotSizeX - Math.max(c, t[1]) / 2 - b), height: Math.max(0, Math.floor(this.plotSizeY - Math.max(c, t[2]) / 2 - d)) };
                a ||
            ...
            drawChartBox: function () {
                ...
                K ? K.animate({ width: x.width, height: x.height }) : (this.clipRect = b.clipRect(x));
                J = "animate";
    ...
    N(H, "parts/ScrollablePlotArea.js", [H["parts/Globals.js"]], function (c) {
        ...
        n(A, "afterSetChartSize", function (n) {
            ...
            if (!this.renderer.forExport) {
                if (z) {
                    ...
                    A &&
                        (this.scrollablePixelsY = z = Math.max(0, A - this.chartHeight)) &&
                        ((this.plotHeight += z), this.inverted ? ((this.clipBox.width += z), (this.plotBox.width += z)) : ((this.clipBox.height += z), (this.plotBox.height += z)), (u = { 2: { name: "bottom", value: z } }));
                u &&
                    !n.skipAxes &&
                    this.axes.forEach(function (n) {
                        u[n.side]
                            ? (n.getPlotLinePath = function () {
                                  var y = u[n.side].name,
                                      z = this[y];
        ...
        A.prototype.setUpScrolling = function () {
            ...
            this.scrollingContainer = c.createElement("div", { className: "highcharts-scrolling" }, n, this.renderTo);
        ...
        A.prototype.moveFixedElements = function () {
            ...
            this.scrollablePixelsX && !this.inverted
                ...
                ? (u = ".highcharts-xaxis")
                : this.scrollablePixelsY && this.inverted && (u = ".highcharts-yaxis");
            z.push(u, u + "-labels");
        ...
        A.prototype.applyFixed = function () {
            ...
            F
                ? ((this.fixedDiv = c.createElement("div", { className: "highcharts-fixed" }, { position: "absolute", overflow: "hidden", pointerEvents: "none", zIndex: 2 }, null, !0)),
                  this.renderTo.insertBefore(this.fixedDiv, this.renderTo.firstChild),
                  (this.renderTo.style.overflow = "visible"),
                  (this.fixedRenderer = A = new c.Renderer(this.fixedDiv, this.chartWidth, this.chartHeight)),
                  (this.scrollableMask = A.path()
                      .attr({
                          fill: c
                              .color(this.options.chart.backgroundColor || "#fff")
                              .setOpacity(c.pick(z.opacity, 0.85))
                              .get(),
                          zIndex: -1,
                      })
            ...
            F = this.scrollablePixelsX
                ? ["M", 0, F, "L", this.plotLeft - 1, F, "L", this.plotLeft - 1, A, "L", 0, A, "Z", "M", L, F, "L", this.chartWidth, F, "L", this.chartWidth, A, "L", L, A, "Z"]
                : this.scrollablePixelsY
                ? ["M", z, 0, "L", z, this.plotTop - 1, "L", u, this.plotTop - 1, "L", u, 0, "Z", "M", z, y, "L", z, this.chartHeight, "L", u, this.chartHeight, "L", u, y, "Z"]
                : ["M", 0, 0];
        ...
        c.Point.prototype = {
            ...
            resolveColor: function () {
                ...
                b.options.colorByPoint
                    ? (d || ((a = b.options.colors || b.chart.options.colors), (this.color = this.color || a[b.colorCounter]), (a = a.length)), (d = b.colorCounter), b.colorCounter++, b.colorCounter === a && (b.colorCounter = 0))
                    : (d = b.colorIndex);
            ...
            optionsToObject: function (b) {
                ...
                if (z(b) || null === b) a[e[0]] = b;
                    ...
                    for (!f && b.length > h && ((d = typeof b[0]), "string" === d ? (a.name = b[0]) : "number" === d && (a.x = b[0]), g++); m < h; )
            ...
            },
            {
                ...
                setOptions: function (a) {
                    ...
                    (!w.negativeColor && !w.negativeFillColor) ||
                        w.zones ||
                        ((k = { value: w[this.zoneAxis + "Threshold"] || w.threshold || 0, className: "highcharts-negative" }), d || ((k.color = w.negativeColor), (k.fillColor = w.negativeFillColor)), c.push(k));
                ...
                updateData: function (a) {
                    ...
                    a.forEach(function (a, e) {
                        ...
                        if (l.id || z(t))
                            if (
                                ((t = this.findPointIndex(l, k)),
                                -1 === t || void 0 === t ? c.push(a) : d[t] && a !== b.data[t] ? (d[t].update(a, !1, null, !1), (d[t].touched = !0), h && (k = t + 1)) : d[t] && (d[t].touched = !0),
                                !g || e !== t || this.hasDerivedData)
                            )
                                f = !0;
                    }, this);
                    if (f) for (a = d.length; a--; ) (e = d[a]) && !e.touched && e.remove(!1);
                    else
                        g
                ...
                setData: function (a, b, d, f) {
                    ...
                    if (!A) {
                        ...
                        if (p && g > p) {
                            ...
                            if (z(m)) for (d = 0; d < g; d++) (I[d] = this.autoIncrement()), (r[d] = a[d]);
                            else if (F(m))
                                if (x) for (d = 0; d < g; d++) (m = a[d]), (I[d] = m[0]), (r[d] = m.slice(1, x + 1));
                                else for (n && ((y = n.indexOf("x")), (E = n.indexOf("y")), (y = 0 <= y ? y : 0), (E = 0 <= E ? E : 1)), d = 0; d < g; d++) (m = a[d]), (I[d] = m[y]), (r[d] = m[E]);
                            else c.error(12, !1, v);
                ...
                getExtremes: function (a) {
                    ...
                    for (r = 0; r < d; r++) {
                        ...
                        if (u && x)
                            if ((u = n.length)) for (; u--; ) z(n[u]) && (e[k++] = n[u]);
                            else e[k++] = n;
                    }
                    this.dataMin = p(e);
                    this.dataMax = m(e);
                ...
                translate: function () {
                    ...
                    for (v = 0; v < q; v++) {
                        ...
                        F(X) &&
                            ((H = X[0]),
                            (D = X[1]),
                            H === x && W.key === N[L].base && (H = h(z(n) && n, e.min)),
                ...
                getClipBox: function (a, b) {
                    var d = this.options,
                        ...
                        k = e && this.yAxis;
                    a && !1 === d.clip && k
                        ? (a = f ? { y: -c.chartWidth + k.len + k.pos, height: c.chartWidth, width: c.chartHeight, x: -c.chartHeight + e.len + e.pos } : { y: -k.pos, height: c.chartHeight, width: c.chartWidth, x: -e.pos })
                ...
                setClip: function (a) {
                    var b = this.chart,
                        ...
                        q = b[h + "m"];
                    g ||
                        (a && ((k.width = 0), f && (k.x = b.plotSizeX + (!1 !== d.clip ? 0 : b.plotTop)), (b[h + "m"] = q = c.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight))),
                        (b[h] = g = c.clipRect(k)),
                        (g.count = { length: 0 }));
                ...
                animate: function (a) {
                    ...
                    if (a) this.setClip(d);
                        ...
                        a && a.animate(f, d);
                        b[c + "m"] && b[c + "m"].animate({ width: f.width + 99, x: f.x - (b.inverted ? 0 : 99) }, d);
                        this.animate = null;
                    }
                },
                    ...
                    a.forEach(function (k, l) {
                        ...
                        k.isNull && !A(b) && 0 < l
                            ...
                            : (0 === l || g
                                  ? (l = ["M", k.plotX, k.plotY])
                                  : c.getPointSpline
                                  ? (l = c.getPointSpline(a, k, l))
                                  : e
                                  ? ((l = 1 === e ? ["L", m.plotX, v] : 2 === e ? ["L", (m.plotX + q) / 2, m.plotY, "L", (m.plotX + q) / 2, v] : ["L", q, m.plotY]), l.push("L", q, v))
                                  : (l = ["L", q, v]),
                              t.push(k.x),
                              e && (t.push(k.x), 2 === e && t.push(k.x)),
                              h.push.apply(h, l),
                              (g = !1));
                    });
                    h.xMap = t;
                ...
                drawGraph: function () {
                    ...
                    f.forEach(function (f, e) {
                        ...
                        l &&
                            !c &&
                            ((k = { stroke: f[2], "stroke-width": b.lineWidth, fill: (a.fillGraph && a.color) || "none" }),
                            f[3] ? (k.dashstyle = f[3]) : "square" !== b.linecap && (k["stroke-linecap"] = k["stroke-linejoin"] = "round"),
                            l[h](k).shadow(2 > e && b.shadow));
                ...
                applyZones: function () {
                    ...
                    if (c.length && (m || v) && r && void 0 !== r.min) {
                        ...
                        c.forEach(function (c, k) {
                            ...
                            u = Math.min(f, e);
                            y = Math.max(f, e);
                            r.isXAxis ? ((q = { x: n ? y : u, y: 0, width: x, height: p }), A || (q.x = b.plotHeight - q.x)) : ((q = { x: 0, y: n ? y : u, width: p, height: x }), A && (q.y = b.plotWidth - q.y));
                            n && d.isVML && (q = r.isXAxis ? { x: 0, y: z ? u : y, height: q.width, width: b.chartWidth } : { x: q.y - b.plotLeft - b.spacingBox.x, y: 0, width: q.height, height: b.chartHeight });
                ...
                plotGroup: function (a, b, d, c, f) {
                    ...
                    e.addClass(
                        "highcharts-" +
                            ...
                            this.type +
                            "-series " +
                            (A(this.colorIndex) ? "highcharts-color-" + this.colorIndex + " " : "") +
                ...
                redraw: function () {
                    var a = this.chart,
                        ...
                        c = this.xAxis,
                        f = this.yAxis;
                    d && (a.inverted && d.attr({ width: a.plotWidth, height: a.plotHeight }), d.animate({ translateX: h(c && c.left, a.plotLeft), translateY: h(f && f.top, a.plotTop) }));
                    this.translate();
                    this.render();
                ...
                searchPoint: function (a, b) {
                    ...
                    return this.searchKDTree({ clientX: f ? d.len - a.chartY + d.pos : a.chartX - d.pos, plotY: f ? c.len - a.chartX + c.pos : a.chartY - c.pos }, b, a);
                },
    ...
    N(H, "parts/Stacking.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.StackItem = function (c, m, p, g, b) {
            ...
            this.alignOptions = { align: m.align || (a ? (p ? "left" : "right") : "center"), verticalAlign: m.verticalAlign || (a ? "middle" : p ? "bottom" : "top"), y: m.y, x: m.x };
        ...
        c.StackItem.prototype = {
            ...
            render: function (c) {
                ...
                this.label
                    ...
                    : ((this.label = m.renderer.label(g, null, null, p.shape, null, null, p.useHTML, !1, "stack-labels")),
                      (g = { text: g, align: this.textAlign, rotation: p.rotation, padding: y(p.padding, 0), visibility: "hidden" }),
                      this.label.attr(g),
                      m.styledMode || this.label.css(p.style),
            ...
            getStackBox: function (c, m, p, g, b, a, d) {
                var f = m.axis.reversed,
                    e = c.inverted;
                c = d.height + d.pos - (e ? c.plotLeft : c.plotTop);
                m = (m.isNegative && !f) || (!m.isNegative && f);
                return { x: e ? (m ? g : g - a) : p, y: e ? c - p - b : m ? c - g - a : c - g, width: e ? a : b, height: e ? b : a };
            },
        };
        ...
        C.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                for (t = 0; t < g; t++) {
                    ...
                    J = q[J][B];
                    null !== I
                        ? ((J.points[l] = J.points[this.index] = [y(J.cumulative, d)]),
                          A(J.cumulative) || (J.base = l),
                          (J.touched = u.stacksTouched),
                          0 < w.index && !1 === this.singleStacks && (J.points[l][0] = J.points[this.index + "," + B + ",0"][0]))
                        : (J.points[l] = J.points[this.index] = null);
                    "percent" === b
                        ? ((k = k ? e : h), r && q[k] && q[k][B] ? ((k = q[k][B]), (J.total = k.total = Math.max(k.total, J.total) + Math.abs(I) || 0)) : (J.total = z(J.total + (Math.abs(I) || 0))))
                        : (J.total = z(J.total + (I || 0)));
    ...
    N(H, "parts/Dynamics.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        a(n.prototype, {
            addSeries: function (a, b, c) {
                ...
                a &&
                    ((b = e(b, !0)),
                    d(k, "addSeries", { options: a }, function () {
                        f = k.initSeries(a);
                        k.isDirtyLegend = !0;
                        k.linkSeries();
            ...
            showLoading: function (d) {
                var c = this,
                    ...
                    q = f.loading,
                    v = function () {
                        h && b(h, { left: c.plotLeft + "px", top: c.plotTop + "px", width: c.plotWidth + "px", height: c.plotHeight + "px" });
                    };
                ...
                c.styledMode || (b(h, a(q.style, { zIndex: 10 })), b(c.loadingSpan, q.labelStyle), c.loadingShown || (b(h, { opacity: 0, display: "" }), m(h, { opacity: q.style.opacity || 0.5 }, { duration: q.showDuration || 0 })));
                c.loadingShown = !0;
                v();
            },
            ...
            update: function (a, b, h, g) {
                var k = this,
                    q = { credits: "addCredits", title: "setTitle", subtitle: "setSubtitle", caption: "setCaption" },
                    l,
                    m,
                    t,
        ...
        a(h.prototype, {
            update: function (a, b, d, c) {
                function f() {
                    ...
                    u(a, !0) &&
                        (h && h.element && a && a.marker && void 0 !== a.marker.symbol && (k.graphic = h.destroy()),
        ...
        a(r.prototype, {
            ...
            update: function (b, k) {
                ...
                var h = this,
                    ...
                    y = {};
                r &&
                    (u.push("data", "isDirtyData", "points", "processedXData", "processedYData", "xIncrement", "_hasPointMarkers", "_hasPointLabels", "mapMap", "mapData", "minY", "maxY", "minX", "maxX"),
                    !1 !== b.visible && u.push("area", "graph"),
                    h.parallelArrays.forEach(function (a) {
                        u.push(a + "Data");
                    }),
                    b.data && this.setData(b.data, !1));
                b = f(q, x, { index: void 0 === q.index ? h.index : q.index, pointStart: e(q.pointStart, h.xData[0]) }, !r && { data: h.options.data }, b);
                ...
                if (r && this.points) {
                    ...
                    !1 === z.visible
                        ...
                        : h._hasPointLabels || ((l = z.marker), (p = z.dataLabels), l && (!1 === l.enabled || "symbol" in l) && (y.graphic = 1), p && !1 === p.enabled && (y.dataLabel = 1));
            ...
            { softThreshold: !1, threshold: 0 },
            {
                ...
                getStackPoints: function (c) {
                    ...
                    if (this.options.stacking) {
                        for (f = 0; f < c.length; f++) (c[f].leftNull = c[f].rightNull = null), (p[c[f].x] = c[f]);
                        A(m, function (a, b) {
                ...
                getGraphPath: function (n) {
                    ...
                    var e = function (c, e, k) {
                        ...
                        void 0 !== m && (g.push({ plotX: r, plotY: null === m ? f : x.getThreshold(m), isNull: h, isCliff: !0 }), p.push({ plotX: r, plotY: null === v ? f : x.getThreshold(v), doCurve: !1 }));
                    };
                    n = n || this.points;
                    ...
                    for (m = 0; m < n.length; m++) {
                        ...
                        if (!h || y) y || e(m, m - 1, "left"), (h && !A && y) || (g.push(n[m]), p.push({ x: m, plotX: r, plotY: E })), y || e(m, m + 1, "right");
                    }
                    m = u.call(this, g, !0, !0);
                    p.reversed = !0;
                    h = u.call(this, p, !0, !0);
                ...
                drawGraph: function () {
                    ...
                    A.forEach(function (u) {
                        var m = u[0],
                            ...
                            g = p ? "animate" : "attr",
                            b = {};
                        p ? ((p.endX = c.preventGraphAnimation ? null : n.xMap), p.animate({ d: n })) : ((b.zIndex = 0), (p = c[m] = c.chart.renderer.path(n).addClass(u[1]).add(c.group)), (p.isArea = !0));
                        c.chart.styledMode || (b.fill = F(u[3], D(u[2]).setOpacity(F(y.fillOpacity, 0.75)).get()));
                        p[g](b);
                        p.startX = n.xMap;
    ...
    N(H, "parts/AreaSplineSeries.js", [H["parts/Globals.js"]], function (c) {
        var n = c.seriesTypes.area.prototype,
            A = c.seriesType;
        A("areaspline", "spline", c.defaultPlotOptions.area, { getStackPoints: n.getStackPoints, getGraphPath: n.getGraphPath, drawGraph: n.drawGraph, drawLegendSymbol: c.LegendSymbolMixin.drawRectangle });
        ("");
    });
        ...
        n(
            ...
            },
            {
                ...
                getColumnMetrics: function () {
                    ...
                    c.columnMetrics = { width: p, offset: (n - p) / 2 + (r + ((c.columnIndex || 0) + (a ? 1 : 0)) * n - h / 2) * (a ? -1 : 1) };
                ...
                pointAttribs: function (c, p) {
                    ...
                    p &&
                        ((c = L(g.states[p], (c.options.states && c.options.states[p]) || {})),
                        (p = c.brightness),
                        (f = c.color || (void 0 !== p && z(f).brighten(c.brightness).get()) || f),
                        (e = c[a] || e),
                        (h = c[d] || h),
                        (b = c.dashStyle || b),
                        (m = y(c.opacity, m)));
                ...
                drawPoints: function () {
                    ...
                    c.points.forEach(function (f) {
                        ...
                        if (D(f.plotY) && null !== f.y) {
                            ...
                            if (e) e[h](L(d));
                            else f.graphic = e = b[f.shapeType](d).add(f.group || c.group);
                ...
                animate: function (c) {
                    ...
                    if (x)
                        if (c) (d.scaleY = 0.001), (c = Math.min(g.pos + g.len, Math.max(g.pos, g.toPixels(b.threshold)))), a ? (d.translateX = c - g.len) : (d.translateY = c), m.clipBox && m.setClip(), m.group.attr(d);
                        else {
        ...
        A(
            ...
            },
            {
                ...
                applyJitter: function () {
                    ...
                    n &&
                        this.points.forEach(function (u, A) {
        ...
        m(
            ...
            },
            {
                ...
                animate: function (b) {
                    ...
                    b ||
                        (d.forEach(function (b) {
                            var d = b.graphic,
                                f = b.shapeArgs;
                            d && (d.attr({ r: b.startR || a.center[3] / 2, start: c, end: c }), d.animate({ r: f.r, start: f.start, end: f.end }, a.options.animation));
                        }),
                        (a.animate = null));
                },
                hasData: function () {
                ...
                translate: function (b) {
                    ...
                    for (v = 0; v < k; v++) {
                        ...
                        var u = g + a * h;
                        t.shapeType = "arc";
                        t.shapeArgs = { x: b[0], y: b[1], r: b[2] / 2, innerR: b[3] / 2, start: Math.round(1e3 * n) / 1e3, end: Math.round(1e3 * u) / 1e3 };
                        ...
                        t.slicedTranslation = { translateX: Math.round(Math.cos(u) * f), translateY: Math.round(Math.sin(u) * f) };
                        var w = (Math.cos(u) * b[2]) / 2;
                        var l = (Math.sin(u) * b[2]) / 2;
                        t.tooltipPos = [b[0] + 0.7 * w, b[1] + 0.7 * l];
                        t.half = u < -Math.PI / 2 || u > Math.PI / 2 ? 1 : 0;
                        t.angle = u;
                        n = Math.min(e, t.labelDistance / 5);
                        t.labelPosition = {
                            natural: { x: b[0] + w + Math.cos(u) * t.labelDistance, y: b[1] + l + Math.sin(u) * t.labelDistance },
                            final: {},
                            alignment: 0 > t.labelDistance ? "center" : t.half ? "right" : "left",
                            connectorPosition: { breakAt: { x: b[0] + w + Math.cos(u) * n, y: b[1] + l + Math.sin(u) * n }, touchingSliceAt: { x: b[0] + w, y: b[1] + l } },
                        };
                    }
                ...
                drawEmpty: function () {
                    ...
                    if (0 === this.total) {
                        ...
                        this.graph.animate({ "stroke-width": b.borderWidth, cx: a, cy: d, r: this.center[2] / 2, fill: b.fillColor || "none", stroke: b.color || "#cccccc" });
                ...
                redrawPoints: function () {
                    ...
                    b.points.forEach(function (f) {
                        ...
                        if (!f.isNull && e) {
                            ...
                            f.delayedRendering
                                ? (e.setRadialReference(b.center).attr(g).attr(c), a.styledMode || e.attr(h).attr({ "stroke-linejoin": "round" }).shadow(m, k), (f.delayedRendering = !1))
                                : (e.setRadialReference(b.center), a.styledMode || u(!0, q, h), u(!0, q, g, c), e.animate(q));
            ...
            },
            {
                ...
                setVisible: function (b, a) {
                    ...
                    a = y(a, h);
                    b !== c.visible &&
                        ((c.visible = c.options.visible = b = void 0 === b ? !c.visible : b),
                ...
                haloPath: function (b) {
                    ...
                    return this.sliced || !this.visible ? [] : this.series.chart.renderer.symbols.arc(a.x, a.y, a.r + b, a.r + b, { innerR: a.r - 1, start: a.start, end: a.end });
                },
                connectorShapes: {
                    fixedOffset: function (b, a, c) {
                        var d = a.breakAt;
                        a = a.touchingSliceAt;
    ...
    N(H, "parts/DataLabels.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        c.distribute = function (a, d, f) {
            ...
            for (
                a = a.map(function (a) {
                    return { size: a.size, targets: [a.target], align: x(a.align, 0.5) };
                });
                g;

            ) {
                for (h = a.length; h--; ) (g = a[h]), (p = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2), (g.pos = Math.min(Math.max(0, p - g.size * g.align), d - g.size));
                h = a.length;
                for (g = !1; h--; )
                    0 < h &&
                        a[h - 1].pos + a[h - 1].size > a[h].pos &&
                        ((a[h - 1].size += a[h].size), (a[h - 1].targets = a[h - 1].targets.concat(a[h].targets)), (a[h - 1].align = 0.5), a[h - 1].pos + a[h - 1].size > d && (a[h - 1].pos = d - a[h - 1].size), a.splice(h, 1), (g = !0));
            }
            m.push.apply(m, q);
            h = 0;
            a.some(function (a) {
                ...
                if (
                    a.targets.some(function () {
                        m[h].pos = a.pos + b;
                        if (Math.abs(m[h].pos - m[h].target) > f)
                            return (
                                m.slice(0, h + 1).forEach(function (a) {
                                    delete a.pos;
                                }),
                                (m.reducedLen = (m.reducedLen || d) - 0.1 * d),
                                m.reducedLen > 0.1 * d && c.distribute(m, d, f),
                                !0
                            );
                        b += m[h].size;
                        h++;
        ...
        p.prototype.drawDataLabels = function () {
            ...
            function b(a, b) {
                ...
                else if (D(a) || D(b)) for (d = Math.max(a.length, b.length); d--; ) c[d] = C(a[d], b[d]);
                else c = C(a, b);
                return c;
            }
            var f = this,
                ...
                m.forEach(function (c) {
                    ...
                    q.forEach(function (b, d) {
                        ...
                        if (k) {
                            ...
                            var n = b.rotation;
                            e.styledMode ||
                                ((p.color = x(b.color, p.color, f.color, "#000000")),
                                "contrast" === p.color && ((c.contrastColor = u.getContrast(c.color || f.color)), (p.color = (!A(q) && b.inside) || 0 > q || h.stacking ? c.contrastColor : "#000000")),
                            ...
                            ? k &&
                              ...
                              (g
                                  ...
                                  : ((c.dataLabels = c.dataLabels || []),
                                    (g = c.dataLabels[d] = n ? u.text(t, 0, -9999).addClass("highcharts-data-label") : u.label(t, 0, -9999, b.shape, null, null, b.useHTML, null, "data-label")),
                                    d || (c.dataLabel = g),
                                    g.addClass(" highcharts-data-label-color-" + c.colorIndex + " " + (b.className || "") + (b.useHTML ? " highcharts-tracker" : ""))),
                              (g.options = b),
                              g.attr(r),
                              e.styledMode || g.css(p).shadow(b.shadow),
                              g.added || g.add(w),
                              b.textPath && !b.useHTML && g.setTextPath((c.getDataLabelPath && c.getDataLabelPath(g)) || c.graphic, b.textPath),
                              f.alignDataLabel(c, g, b, null, m))
                            : ((c.dataLabel = c.dataLabel && c.dataLabel.destroy()),
                              c.dataLabels && (1 === c.dataLabels.length ? delete c.dataLabels : delete c.dataLabels[d]),
                              d || delete c.dataLabel,
                              l && ((c.connector = c.connector.destroy()), c.connectors && (1 === c.connectors.length ? delete c.connectors : delete c.connectors[d])));
                    });
                });
            }
        ...
        p.prototype.alignDataLabel = function (a, b, c, e, h) {
            ...
            if (u) {
                ...
                e = H({ x: f ? this.yAxis.len - m : g, y: Math.round(f ? this.xAxis.len - g : m), width: 0, height: 0 }, e);
                H(c, { width: k.width, height: k.height });
                p
                    ? ((w = !1),
                      (g = d.renderer.rotCorr(l, p)),
                      (g = { x: e.x + c.x + e.width / 2 + g.x, y: e.y + c.y + { top: 0, middle: 0.5, bottom: 1 }[c.verticalAlign] * e.height }),
                      b[h ? "attr" : "animate"](g).attr({ align: n }),
                      (m = (p + 720) % 360),
                      (m = 180 < m && 360 > m),
                      "left" === n ? (g.y -= m ? k.height : 0) : "center" === n ? ((g.x -= k.width / 2), (g.y -= k.height / 2)) : "right" === n && ((g.x -= k.width), (g.y -= m ? 0 : k.height)),
                      (b.placed = !0),
                      (b.alignAttr = g))
                    : (b.align(c, null, e), (g = b.alignAttr));
                ...
                if (c.shape && !p) b[h ? "attr" : "animate"]({ anchorX: f ? d.plotWidth - a.plotY : a.plotX, anchorY: f ? d.plotHeight - a.plotX : a.plotY });
            }
        ...
        g.pie &&
                        ...
                        a.dataLabel &&
                            (a.visible
                                ? (L[a.half].push(a),
                                  ...
                                  !A(g.style.width) &&
                                      !A(a.options.dataLabels && a.options.dataLabels.style && a.options.dataLabels.style.width) &&
                        ...
                        if (h) {
                            ...
                            if (0 < a.maxLabelDistance) {
                                ...
                                b.forEach(function (a) {
                                    0 < a.labelDistance &&
                                        a.dataLabel &&
                                        ((a.top = Math.max(0, l - w - a.labelDistance)),
                                        (a.bottom = Math.min(l + w + a.labelDistance, e.plotHeight)),
                                        (n = a.dataLabel.getBBox().height || 21),
                                        (a.distributeBox = { target: a.labelPosition.natural.y - a.top + n / 2, size: n, rank: a.y }),
                            ...
                            for (Q = 0; Q < h; Q++) {
                                ...
                                J._attr = { visibility: N, align: F.alignment };
                                ...
                                x(g.crop, !0) &&
                                    ((D = J.getBBox().width),
                                    (t = null),
                                    M - D < m && 1 === d ? ((t = Math.round(D - M + m)), (P[3] = Math.max(t, P[3]))) : M + D > q - m && 0 === d && ((t = Math.round(M + D - q + m)), (P[1] = Math.max(t, P[1]))),
                                    0 > G - H / 2 ? (P[0] = Math.max(Math.round(-G + H / 2), P[0])) : G + H / 2 > v && (P[2] = Math.max(Math.round(G + H / 2 - v), P[2])),
                                    (J.sideOverflow = t));
                            }
                        }
                    }),
                    0 === u(P) || this.verifyDataLabelOverflow(P)) &&
                    ...
                    this.points.forEach(function (b) {
                        ...
                        if ((n = x(V.connectorWidth, 1))) {
                            ...
                            if ((J = b.dataLabel) && J._pos && b.visible && 0 < b.labelDistance) {
                                ...
                                if ((c = !y))
                                    (b.connector = y = e.renderer
                                        .path()
                                        .addClass("highcharts-data-label-connector  highcharts-color-" + b.colorIndex + (b.className ? " " + b.className : ""))
                                        .add(a.dataLabelsGroup)),
                                        e.styledMode || y.attr({ "stroke-width": n, stroke: V.connectorColor || b.color || "#666666" });
            ...
            (g.pie.prototype.placeDataLabels = function () {
                this.points.forEach(function (a) {
                    ...
                    b &&
                        ...
                        ((c = b._pos)
                            ? (b.sideOverflow &&
                                  ((b._attr.width = Math.max(b.getBBox().width - b.sideOverflow, 0)),
                                  b.css({ width: b._attr.width + "px", textOverflow: (this.options.dataLabels.style || {}).textOverflow || "ellipsis" }),
                                  (b.shortened = !0)),
                              b.attr(b._attr),
            ...
            (g.pie.prototype.alignDataLabel = n),
        ...
        g.column &&
            (g.column.prototype.alignDataLabel = function (a, b, c, e, g) {
                ...
                h &&
                    ...
                    (h = e.y + e.height - f.yAxis.len),
                    0 < h && (e.height -= h),
                    d && (e = { x: f.yAxis.len - e.y - e.height, y: f.xAxis.len - e.x - e.width, width: e.height, height: e.width }),
    ...
    N(H, "modules/overlapping-datalabels.src.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        z(n, "render", function () {
            ...
            (this.yAxis || []).forEach(function (n) {
                n.options.stackLabels &&
                    !n.options.stackLabels.allowOverlap &&
            ...
            (this.series || []).forEach(function (n) {
                ...
                n.visible &&
                    (!1 !== u.enabled || n._hasPointLabels) &&
                    n.points.forEach(function (n) {
                        n.visible &&
                            (A(n.dataLabels) ? n.dataLabels : n.dataLabel ? [n.dataLabel] : []).forEach(function (m) {
                                var p = m.options;
        ...
        n.prototype.hideOverlappingLabels = function (c) {
            ...
            var b = function (a) {
                ...
                if (a && (!a.alignAttr || a.placed)) {
                    ...
                    return { x: d.x + (f.translateX || 0) + b, y: d.y + (f.translateY || 0) + b - c, width: a.width - 2 * b, height: a.height - 2 * b };
                }
            };
                    ...
                    a.oldOpacity !== c &&
                        (a.alignAttr && a.placed
                            ? (c
                              ...
                              u(n, "afterHideOverlappingLabels"))
                            : a.attr({ opacity: c }));
                    a.isOld = !0;
                }
            });
    ...
    N(H, "parts/Interaction.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        var E = (c.TrackerMixin = {
                ...
                a._hasTracking ||
                    (a.trackerGroups.forEach(function (e) {
                        if (a[e]) {
                            ...
                            !b.styledMode && a.options.cursor && a[e].css(y).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function () {
                var a = this,
                    ...
                    y = "rgba(192,192,192," + (r ? 0.0001 : 0.002) + ")";
                if (e && !c) for (u = e + 1; u--; ) "M" === d[u] && d.splice(u + 1, 0, d[u + 1] - m, d[u + 2], "L"), ((u && "M" === d[u]) || u === e) && d.splice(u, 0, "L", d[u - 2] + m, d[u - 1]);
                n
                    ? n.attr({ d: d })
                    : a.graph &&
                      ((a.tracker = l
                          ...
                          .add(a.group)),
                      f.styledMode || a.tracker.attr({ "stroke-linejoin": "round", stroke: y, fill: c ? y : "none", "stroke-width": a.graph.strokeWidth() + (c ? 0 : 2 * m) }),
        ...
        m(b.prototype, {
            ...
            createCheckboxForItem: function (a) {
                a.checkbox = H("input", { type: "checkbox", className: "highcharts-legend-checkbox", checked: a.selected, defaultChecked: a.selected }, this.options.itemCheckboxStyle, this.chart.container);
                ...
                c.firePointEvent(a ? "select" : "unselect", { accumulate: b }, function () {
                    ...
                    b ||
                        f.getSelectedPoints().forEach(function (a) {
                            ...
                            a.selected &&
                                a !== c &&
                                ((a.selected = a.options.selected = !1), (b.options.data[b.data.indexOf(a)] = a.options), a.setState(f.hoverPoints && b.options.inactiveOtherPoints ? "inactive" : ""), a.firePointEvent("unselect"));
                        });
                });
                ...
                if (!((a === this.state && !b) || (this.selected && "select" !== a) || !1 === f.enabled || (a && (n || (h && !1 === l.enabled))) || (a && r.states && r.states[a] && !1 === r.states[a].enabled))) {
                    ...
                    if (this.graphic) {
                        ...
                        if (a && l) {
                            ...
                            if (y)
                                if (q) q[b ? "animate" : "attr"]({ x: y.x, y: y.y });
                    ...
                    a && a.size && q && "hidden" !== f
                        ? (u || (c.halo = u = v.renderer.path().add(q.parentGroup)),
                          u.show()[b ? "animate" : "attr"]({ d: this.haloPath(a.size) }),
                          u.attr({ class: "highcharts-halo highcharts-color-" + d(this.colorIndex, c.colorIndex) + (this.className ? " " + this.className : ""), visibility: f, zIndex: -1 }),
                          (u.point = this),
                          v.styledMode || u.attr(m({ fill: this.color || c.color, "fill-opacity": a.opacity }, a.attributes)))
                        : u && u.point && u.point.haloPath && u.animate({ d: u.point.haloPath(0) }, null, u.hide);
    ...
    N(H, "parts/Responsive.js", [H["parts/Globals.js"], H["parts/Utilities.js"]], function (c, n) {
        ...
        n.prototype.setResponsive = function (n, u) {
            ...
            x = x.toString() || void 0;
            x !== (m && m.ruleIds) &&
                (m && this.update(m.undoOptions, n, !0),
                x ? ((m = this.currentOptions(u)), (m.isResponsiveOptions = !0), (this.currentResponsive = { ruleIds: x, mergedOptions: u, undoOptions: m }), this.update(u, n, !0)) : (this.currentResponsive = void 0));
        };
        ...
        n.prototype.currentOptions = function (c) {
            function n(c, p, g, b) {
                var a;
                F(c, function (c, f) {
                    if (!b && -1 < u.collectionsWithUpdate.indexOf(f)) for (c = z(c), g[f] = [], a = 0; a < c.length; a++) p[f][a] && ((g[f][a] = {}), n(c[a], p[f][a], g[f][a], b + 1));
