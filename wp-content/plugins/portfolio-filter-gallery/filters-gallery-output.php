...
while ( $loop->have_posts() ) : $loop->the_post();
	...
	<div class="portfolio-wraper pfg-bootstrap">
		...
		<div class="filter_gallery_<?php echo $pf_gallery_id; ?> row filtr-container filters-div">
			<?php
					...
					if($image_link_url) {
						if($image_type == 'image') { ?>
							<a href="<?php echo esc_url($image_link_url); ?>" title="<?php echo esc_html($title); ?>" target="<?php echo esc_html($url_target); ?>">
								<div data-category="<?php echo esc_html($filter_keys); ?>" data-sort="<?php echo esc_html($title); ?>" class="filtr-item filtr_item_<?php echo esc_html($pf_gallery_id); ?> single_one <?php echo esc_html($col_large_desktops); ?> <?php echo esc_html($col_desktops); ?> <?php echo esc_html($col_tablets); ?> <?php echo esc_html($col_phones); ?>">
									<img class="<?php if($thumb_border == "yes") { ?> thumbnail <?php } ?> thumbnail_<?php echo esc_html($pf_gallery_id); ?> pfg-img pfg_img_<?php echo esc_html($pf_gallery_id); ?> img-responsive <?php echo esc_html($image_hover_effect); ?>" src="<?php echo esc_html($thumbnail_url); ?>" alt="<?php echo get_post_meta( $attachment_id, '_wp_attachment_image_alt', true ); ?>">
									<?php 
									if($image_numbering) { ?>
