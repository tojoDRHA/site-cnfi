...
if ( !class_exists("SEOFacebookCommentsAdmin") )
{
    class SEOFacebookCommentsAdmin extends PlulzAPI
    {
        ...
        protected function _init()
        {
            ...
            if (empty($this->_fwork))
                throw new Exception('Must define the $_fwork property');
        }
...
//            }
        ...
        protected function _help( $helpLinks = null )
        {
            $html = "<div id='links' class='postbox'>" .
                ...
                "<h3 class='hndle'>" . __('Need Assistance?', $this->_fwork) . "</h3>" .
                "<div class='inside'>" .
                    "<p>" . __('Problems? The links bellow can be very helpful to you', $this->_fwork). "</p>" .
                    "<ul>" .
                        "<li><a href='http://wordpress.org/tags/{$this->wordpressLink}' target='_blank'>Wordpress Help Forum</a></li>";
...
//            }
         ...
         * @return void
         */
        protected function _loved( $links = null )
        {

            $html = "<div id='links' class='postbox'>" .
                        "<div class='handlediv' title='Click to Toggle'><br/></div>" .
                        "<h3 class='hndle'>" . __('Loved this Plugin?', $this->_fwork) . "</h3>" .
                        "<div class='inside'>" .
                            "<p>" . __('Below are some links to help spread this plugin to other users', $this->_fwork) . "</p>" .
                            "<ul>" .
                                "<li><a href='http://wordpress.org/extend/plugins/{$this->wordpressLink}' target='_blank'>" . __('Give it a 5 star on Wordpress.org', $this->_fwork) . "</a></li>" .
                                "<li><a href='http://wordpress.org/extend/plugins/{$this->wordpressLink}' target='_blank'>" . __('Link to it so others can easily find it', $this->_fwork) . "</a></li>" .
                                "<li><a href='" . self::$DOMAIN['facebook'] . "' target='_blank'>" . __('Find us on Facebook', $this->_fwork) . "</a></li>";

//            if (!$links)    // Api is unreachable or slow
//            {
//                $html .=    "<li><a href='http://wordpress.org/extend/plugins/{$this->wordpressLink}' target='_blank'>" . __('Give it a 5 star on Wordpress.org', $this->_fwork) . "</a></li>" .
//                            "<li><a href='http://wordpress.org/extend/plugins/{$this->wordpressLink}' target='_blank'>" . __('Link to it so others can easily find it', $this->_fwork) . "</a></li>";
//            }
//            else
//            {
...
//            }
        ...
        protected function _donate( $donateLinks = null )
        {
            $html = "<div id='donate' class='postbox'>" .
                        "<div class='handlediv' title='Click to Toggle'><br/></div>" .
                        "<h3 class='hndle'>" . __('About us', $this->_fwork) . "</h3>" .
                        "<div class='inside'>" .
                        __('We are a Web 2.0 enterpreneurship in Brazil. We provide solutions on Wordpress and other systems, creating Themes, Plugins and many more exciting apps. Known more at', $this->_fwork) . '<a href="' . self::$DOMAIN['www'] . '" target="_blank" title="Plulz"> Plulz </a>';

//            if ( $donateLinks && is_string($donateLinks->form) )
//                $html .= "{$donateLinks->form}";
//            else
//            {
//                $html .= __('We are a Web 2.0 enterpreneurship in Brazil. We provide solutions on Wordpress and other systems, creating Themes, Plugins and many more exciting apps. Known more at', $this->_fwork) . '<a href="' . self::$DOMAIN['www'] . '" target="_blank" title="Plulz"> Plulz </a>';
//            }
        ...
        public function hookDashboard()
        {
            ...
            wp_add_dashboard_widget('PlulzDashNews', __('Plulz Latest News', $this->_fwork), array( &$this, 'dashboardNews'));
       ...
       /*
        ...
        public function dashboardNews()
        {
            ...
            $output .=  '</ul>' .
                        ...
                        '<img src="' . $this->menuPage['icon_url'] . '" style="position:absolute;bottom:0;left:0;" /><a href="' . self::$DOMAIN['www'] . '" style="padding-left:19px;" target="_blank">' . __('Wordpress Plugins at Plulz', $this->_fwork) . '</a>' .
                        '<img src="' . $this->menuPage['fbico_url'] . '" style="position:absolute;bottom:0;right:148px;" /><a href="' . self::$DOMAIN['facebook'] . '" style="float: right" target="_blank">' . __('Follow Plulz on Facebook', $this->_fwork) . '</a>' .
                        '</div>';
