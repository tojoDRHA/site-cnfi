...
We are a Web 2.0 enterpreneurship in Brazil. We provide solutions on Wordpress and other systems, creating Themes, Plugins and many more exciting apps. Known more at [Plulz](http://www.plulz.com/)
...
Example: <?php do_action('seo_facebook_comments'); ?>
...
* <strong>ADDED</strong> Screen size auto detection for Fluid Layouts
* <strong>FIXED</strong> Bug fix caused in Fluid Layouts after an update from Facebook on their Comment Plugin

= 1.5.1 =

* <strong>ADDED<strong> The mobile version of the Facebook Comments Plugin
* <strong>ADDED</strong> How the comments should be sorted. The available options are: "social", "reverse_time" or "time"
* <strong>ADDED</strong> A hook that allows the SEO Facebook Comment to be called directly in the template for sites that do not use the default comment_template function (custom themes)
* <strong>TWEAK</strong> The plugin now accepts width parameters in px for fixed layouts or in % for fluid layouts
* <strong>FIXED</strong> Layout fix in the admin configuration page for Wordpress 3.8+

= 1.5 =

* <strong>UPDATE</strong> Added multilanguage support. Initially the available languages are Brazilian Portuguese (pt_BR) and US English (en_US)
* <strong>UPDATE</strong> All Facebook PHP SDK Files are now up to date
* <strong>TWEAK</strong> Many layout improvements
...
* Bug fixes and layout detection improvements. Upgrade Highly Advisable.

= 1.5.1 =

* Major new options and customizations added to th eplugin. Upgrade Highly Advisable.
